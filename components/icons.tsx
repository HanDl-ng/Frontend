...
export function ChevronLeftIcon({ className, fill }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke={fill || 'currentColor'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function HelpCircleIcon({ className, fill }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke={fill || 'currentColor'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function XIcon({ className, fill }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke={fill || 'currentColor'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function TicketIcon({ className, fill }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke={fill || 'currentColor'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function BookOpenIcon({ className, fill }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke={fill || 'currentColor'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function MessageSquareIcon({ className, fill }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke={fill || 'currentColor'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" />
    </svg>
...
export function LifeBuoyIcon({ className, fill }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke={fill || 'currentColor'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function ExternalLinkIcon({ className, fill }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke={fill || 'currentColor'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function PauseIcon({ className, fill }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke={fill || 'currentColor'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function PlayIcon({ className, fill }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke={fill || 'currentColor'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function AlertCircleIcon({ className, fill }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke={fill || 'currentColor'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function CreditCardProcessIcon({ className, fill }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke={fill || 'currentColor'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <rect x="1" y="4" width="22" height="16" rx="2" ry="2" /><line x1="1" y1="10" x2="23" y2="10" /><path d="M7 15h3M14 15h3" />
    </svg>
  );
}

export function TruckIcon({ className, fill }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke={fill || 'currentColor'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function LogOutIcon({ className, fill }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke={fill || 'currentColor'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function SparklesIcon({ className, fill }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke={fill || 'currentColor'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function MoreHorizontalIcon({ className, fill }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke={fill || 'currentColor'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function ArchiveIcon({ className, fill }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke={fill || 'currentColor'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function BanIcon({ className, fill }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke={fill || 'currentColor'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function EyeOffIcon({ className, fill }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke={fill || 'currentColor'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94" /><path d="M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19" /><path d="M1 1l22 22" /><path d="M14.12 14.12a3 3 0 1 1-4.24-4.24" />
    </svg>
  );
}

export function CopyIcon({ className, fill }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke={fill || 'currentColor'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
