    ...
    <div className="dash-attention-card">
      ...
      <div className="dash-ai-summary">
        ...
        <p className="dash-ai-summary-text">
          AI agent handled <strong>124 conversations</strong> today with <strong>87% resolution rate</strong>.
          Created <strong>28 orders</strong> totaling <strong>₦1.4M</strong>. 3 conversations need human attention.
        </p>
      </div>
    </div>
  );
